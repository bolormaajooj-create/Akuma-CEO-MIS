    ...
    <div style={{minHeight:'100vh',background:'#F7F8FA',display:'flex',alignItems:'center',justifyContent:'center'}}>
      <div style={{background:'#fff',padding:32,borderRadius:16,border:'1px solid #E5E7EB',width:360}}>
        ...
        <input
          ...
          style={{width:'100%',padding:'10px',border:'1px solid #E5E7EB',borderRadius:8,marginBottom:12,fontSize:14}}
        />
        <input
          type="password"
          placeholder="Нууц үг"
        ...
        <button
          onClick={login}
          style={{width:'100%',background:'#111827',color:'#fff',border:'none',borderRadius:8,padding:'12px',fontSize:14,cursor:'pointer'}}
        >
          Нэвтрэх
        </button>
      </div>
