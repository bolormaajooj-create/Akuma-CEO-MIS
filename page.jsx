      ...
      <div style={{ width:'100%', maxWidth:400 }}>
        ...
        <div style={{ background:'#fff', borderRadius:16, border:'1px solid #E5E7EB', padding:32 }}>
          ...
          <button
            onClick={handleLogin}
            disabled={loading}
            style={{ width:'100%', background:'#111827', color:'#fff', border:'none', borderRadius:10, padding:'12px', fontSize:14, fontWeight:600, cursor:loading?'wait':'pointer', opacity:loading?0.7:1, transition:'all 0.15s' }}
          >
        ...
        <p style={{ textAlign:'center', fontSize:11, color:'#D1D5DB', marginTop:20 }}>
          Akuma CEO Dashboard · Хувийн хандалт
        </p>
      </div>
    </div>
  );
